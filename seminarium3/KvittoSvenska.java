class KvittoSvenska
{
	...
	KvittoSvenska(SaleInfo saleInfo)
	{
	...
	private void printReciept()
	{
		...
		*/
		System.out.println("---------------------------------------------------------------------------");
		System.out.println("tid av försäljning: "+dateAndTimeOfSale);
		...
		System.out.println("");
		System.out.println("totalt: "+saleInfo.taTotal()+"kr");
		System.out.println("");
		saleInfo.taPayment();
		saleInfo.taChange();
		System.out.println("betalat: "+saleInfo.taPayment()+" tillbaka: "+saleInfo.taChange());
		System.out.println("---------------------------------------------------------------------------");
	}
}